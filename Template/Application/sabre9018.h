...
static unsigned char sabre9018_init_reg[64]=
{
			...
			0x8C,	//SABRE9018_REG_INPUTCONFIG
			0x00,	//SABRE9018_REG_SOFTVOLUMECTRL_1
			0x68,	//SABRE9018_REG_SOFTVOLUMECTRL_2
			0x4A,	//SABRE9018_REG_SOFTVOLUMECTRL_3
			0x80,	//SABRE9018_REG_GENERALSETTING
			0x88,	//SABRE9018_REG_GPIOCONFIG
			0x02, //SABRE9018_REG_MASTERMODECTRL
			0x02, //SABRE9018_REG_CHANNELMAPPING
			0x5A, //SABRE9018_REG_DPLL_ASRC_SETTING
			0x40, //SABRE9018_REG_THDCOMPENSATION
			0x8A, //SABRE9018_REG_SOFTSTARTSETTING
			0x50, //SABRE9018_REG_VOLUME_1
			0x50, //SABRE9018_REG_VOLUME_2
			...
			0x00, //SABRE9018_REG_FSYNCCTRL_1
			0x04, //SABRE9018_REG_HEADPHONEAMPLIFERBIASCTRL
			0x20, //SABRE9018_REG_HEADPHONEAMPLIFERCTRL
